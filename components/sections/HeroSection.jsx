...
// // //                         Prayag <span className="text-pink-400">Sahu</span>
// // //                     </h1>

// // //                     {/* ROLE LINE (can be animated later) */}
// // //                     <h3 className="text-2xl lg:text-3xl text-gray-200 mb-6">
// // //                         And I&apos;m a{" "}
...
// // //                     {/* DESCRIPTION */}
// // //                     <p className="text-lg text-gray-200 max-w-xl mb-8 leading-relaxed">
// // //                         I am a <strong>Freelancer</strong> and <strong>Problem Solver</strong> with
// // //                         strong expertise in <strong>C++, Java, JavaScript</strong>, and
// // //                         <strong> Database Management</strong>.
// // //                         I build scalable, performance-optimized full stack web applications
// // //                         with clean UI/UX and reliable backend logic.
// // //                     </p>
...
// // //                         <a
// // //                             href="#projects"
// // //                             className="px-8 py-4 rounded-full bg-gradient-to-r from-pink-500 to-purple-600 font-semibold text-white hover:scale-105 transition"
// // //                         >
// // //                             View My Work
// // //                         </a>
...
// // //                         <a
// // //                             href="#contact"
// // //                             className="px-8 py-4 rounded-full border border-purple-400 text-purple-300 hover:bg-purple-500 hover:text-white transition"
// // //                         >
// // //                             Get In Touch
// // //                         </a>

// // //                         <a
// // //                             href="/Prayag_Sahu_CV.pdf"
...
// // // export default function HeroSection() {
// // //     return (
// // //         // <ParallaxSection videoSrc="/video/bg.mp4" width="2000">
// // //                 <ParallaxSection
...
// // //             >
// // //                 {/*  bg-gradient-to-br from-[#070b18] via-[#0b1022] to-[#070b18] */}
// // //                 <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
...
// // //                             I&apos;m <span className="text-cyan-400 font-semibold">Prayag Sahu</span>
// // //                         </h3>

// // //                         <p className="text-gray-400 max-w-xl leading-relaxed">
// // //                             Freelancer & Full Stack Developer with strong expertise in
// // //                             <strong> React, Next, Node, C++, Java, JavaScript</strong> and
// // //                             <strong> Database Management</strong>.
// // //                             I build clean, scalable and performance-driven web applications
// // //                             with a strong focus on UI/UX and backend architecture.
// // //                         </p>
...
// // //                             <a
// // //                                 href="#projects"
// // //                                 className="px-6 py-3 rounded-lg bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-semibold hover:scale-105 transition"
// // //                             >
// // //                                 View My Work
// // //                             </a>
...
// // //                             <a
// // //                                 href="#contact"
// // //                                 className="px-6 py-3 rounded-lg border border-cyan-400 text-cyan-300 hover:bg-cyan-500 hover:text-black transition"
// // //                             >
// // //                                 Get In Touch
// // //                             </a>
...
// // //                             <div className="bg-[#0f172a] p-4 rounded-xl text-center border border-white/5">
...
// // //                         <div className="bg-[#0f172a] p-4 rounded-2xl shadow-2xl border border-white/5 max-w-md">
// // //                             <Image
// // //                                 src="/images/1.png"
// // //                                 alt="Prayag Sahu"
// // //                                 width={1200}
...
function Cursor() {
    return <span className="inline-block w-[10px] h-[20px] bg-[#39d353] animate-pulse ml-1 align-middle" />;
}
                ...
                {[...Array(numCopies)].map((_, i) => (
                    <div key={i} ref={i === 0 ? copyRef : null} className="flex gap-4">
                        {icons.map((IconEl, idx) => (
                            <div key={idx}
                                className="w-12 h-12 border border-[#1a2332] bg-[#010409]/90 backdrop-blur-xl flex items-center justify-center transition-all duration-200 hover:border-[#39d353] hover:shadow-[0_0_12px_rgba(57,211,83,0.2)]"
...
/* ══════════════════════════════════════════
   PROFILE CARD (TiltedCard inlined & restyled)
══════════════════════════════════════════ */
import ParallaxSection from '@/components/ui/ParallaxSection';
        ...
        <div className="flex flex-col items-center" style={{ fontFamily: "'Courier New', Courier, monospace" }}>
            ...
            >
                ...
                <div className="border border-[#1a2332] bg-[#0d1117] relative overflow-hidden"
                    style={{ borderTopWidth: 3, borderTopColor: "#39d353", borderTopStyle: "solid", boxShadow: "0 0 40px rgba(57,211,83,0.08)" }}>
                    <ScanlineOverlay />
                    <CornerAccent color="#39d353" />

                    {/* Window chrome */}
                    <div className="flex items-center justify-between px-4 py-2.5 border-b border-[#1a2332] relative z-10">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-mono text-[9px] tracking-[0.2em] text-[#8b949e]">PROFILE.exe</span>
                        </div>
                        <div className="flex items-center gap-1">
                            <div className="w-1.5 h-1.5 rounded-full bg-[#39d353] animate-pulse" />
                            <span className="font-mono text-[8px] text-[#39d353] border border-[#39d353] px-1.5 py-0.5 tracking-widest">ACTIVE</span>
                        </div>
                    </div>
                    ...
                    <div className="p-4 relative z-10">
                        <div className="font-mono font-black text-[17px] text-white tracking-wide">{name}</div>
                        <div className="font-mono text-[11px] text-[#39d353] tracking-[0.2em] mb-3">{role}</div>
                        ...
                        {/* Social strip */}
                        <div className="border border-[#1a2332] bg-[#010409] relative overflow-hidden">
                            <CornerAccent color="#1a2332" />
                            <div className="flex items-center gap-2 px-3 py-2">
                                <button onClick={() => setOpen(!open)}
                                    className="w-7 h-7 border flex items-center justify-center text-[#39d353] shrink-0 transition-all duration-300"
                                    style={{ borderColor: "#39d353", transform: open ? "rotate(45deg)" : "rotate(0)" }}>
                                    <RiAddLine size={14} />
                                </button>
                                {!open && (
                                    <span className="font-mono text-[10px] text-[#39d353] tracking-widest whitespace-nowrap">SOCIAL_LINKS</span>
                                )}
                                {open && (
                                    <div className="flex items-center gap-3">
                                        {[
                                            ...
                                            <a key={i} href={s.href} target="_blank" rel="noopener noreferrer"
                                                ...
                                                onMouseLeave={e => { e.currentTarget.style.borderColor = "#1a2332"; e.currentTarget.style.boxShadow = "none"; }}>
                                                {s.icon}
                                            </a>
                                        ))}
                                    </div>
            ...
            <div className="flex items-center gap-3 mt-4 w-full">
                <a href="#contact"
                    className="flex-1 flex items-center justify-center gap-2 border border-[#39d353] font-mono text-[11px] tracking-[0.18em] uppercase py-3 text-[#39d353] transition-all duration-200 hover:bg-[#39d353] hover:text-[#010409]">
                    <Terminal size={13} /> HIRE_ME →
                </a>
                <a href="tel:+917999926855"
                    className="flex-1 flex items-center justify-center gap-2 border border-[#1a2332] font-mono text-[11px] tracking-[0.18em] uppercase py-3 text-[#8b949e] transition-all duration-200 hover:border-[#00e5ff] hover:text-[#00e5ff] relative overflow-hidden group"
                    style={{ animation: "phone-pulse 2.5s infinite" }}>
...
export default function HeroSection() {
    ...
    const roles = ['FULL_STACK_DEVELOPER', 'FREELANCER', 'UI/UX_DESIGNER', 'OPEN_SOURCE_CONTRIBUTOR'];
